...
const Battery = ({...props}) => {
  ...
  const d3 = `M8.5 111.403V124.5C8.5 125.605 9.39543 126.5 10.5 126.5H${calcH1}V111.383C${calcH1} 111.13 ${calcH1} 110.879 ${calcH1} 110.644L${calcD3} 88.7618C67.365 88 266.629 87.5 165.809 87.5H19.7109C18.9059 87.5 18.1794 87.9826 17.8673 88.7247L8.65638 110.628C8.55317 110.874 8.5 111.137 8.5 111.403Z`;
